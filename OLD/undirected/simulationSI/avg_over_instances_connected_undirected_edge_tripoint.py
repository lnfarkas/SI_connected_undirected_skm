...
mean_edge_type_list, var_edge_type_list = [], []
mean_tripoint_list, var_tripoint_list = [], []
...
for f in selected_files:
    ...
    mean_edge_type_list.append(d["mean_edge_type_counts_in_time_in_one_instance"])
    var_edge_type_list.append(d["var_edge_type_counts"])
    mean_tripoint_list.append(d["mean_tripoint_type_counts_in_time_in_one_instance"])
    var_tripoint_list.append(d["var_tripoint_type_counts"])
...
mean_edge_type_arr = np.array(mean_edge_type_list)
var_edge_type_arr = np.array(var_edge_type_list)
mean_tripoint_arr = np.array(mean_tripoint_list)
var_tripoint_arr = np.array(var_tripoint_list)
...
mean_edge_type = mean_edge_type_arr.mean(axis=0)
mean_tripoint = mean_tripoint_arr.mean(axis=0)
...
var_fractions = var_fractions_intra + var_fractions_inter

var_edge_type = var_edge_type_arr.mean(axis=0) + mean_edge_type_arr.var(axis=0, ddof=1)

var_tripoint = var_tripoint_arr.mean(axis=0) + mean_tripoint_arr.var(axis=0, ddof=1)
...
np.savez_compressed(
    ...
    mean_edge_type_counts=mean_edge_type,
    var_edge_type_counts=var_edge_type,

    mean_tripoint_type_counts=mean_tripoint,
    var_tripoint_type_counts=var_tripoint,
